#
#  Be sure to run `pod spec lint GMDKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "GMDKit"
  s.version      = "0.0.1"
  s.summary      = "GMDKit is collections of iOS Controls which are implementation of Google Material Design."
...
s.source       = { :git => "https://github.com/alokc83/GMDKit.git", :tag => "#{s.version}" }
